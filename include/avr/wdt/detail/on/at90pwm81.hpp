...
inline void on_impl(uint8_t enable, at_1ms_t) noexcept
{ detail::_wdtcr = enable | wdp3 | wdp2 | wdp0; }

inline void on_impl(uint8_t enable, at_2ms_t) noexcept
{ detail::_wdtcr = enable | wdp3 | wdp2; }

inline void on_impl(uint8_t enable, at_4ms_t) noexcept
{ detail::_wdtcr = enable | wdp3 | wdp1 | wdp0; }

inline void on_impl(uint8_t enable, at_8ms_t) noexcept
{ detail::_wdtcr = enable | wdp3 | wdp1; }
