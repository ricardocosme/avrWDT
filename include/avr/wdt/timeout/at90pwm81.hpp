...
AVR_WDT_INLINE_GLOBAL(at_1ms)
AVR_WDT_INLINE_GLOBAL(at_2ms)
AVR_WDT_INLINE_GLOBAL(at_4ms)
...
struct is_timeout {
    static constexpr bool value =
        detail::is_same<Timeout, at_1ms_t>::value
        | detail::is_same<Timeout, at_2ms_t>::value
        | detail::is_same<Timeout, at_4ms_t>::value
