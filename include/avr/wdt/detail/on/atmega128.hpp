...
inline void on_impl(uint8_t enable, at_14ms_t) noexcept
{ detail::_wdtcr = enable; }

inline void on_impl(uint8_t enable, at_28ms_t) noexcept
{ detail::_wdtcr = enable | wdp0; }

inline void on_impl(uint8_t enable, at_56ms_t) noexcept
{ detail::_wdtcr = enable | wdp1; }

inline void on_impl(uint8_t enable, at_110ms_t) noexcept
{ detail::_wdtcr = enable | wdp1 | wdp0; }

inline void on_impl(uint8_t enable, at_220ms_t) noexcept
{ detail::_wdtcr = enable | wdp2; }

inline void on_impl(uint8_t enable, at_450ms_t) noexcept
{ detail::_wdtcr = enable | wdp2 | wdp0; }

inline void on_impl(uint8_t enable, at_900ms_t) noexcept
{ detail::_wdtcr = enable | wdp2 | wdp1; }

inline void on_impl(uint8_t enable, at_1800ms_t) noexcept
