...
inline void on_impl(uint8_t enable, at_512K_t) noexcept
{ detail::_wdtcr = enable | wdp2 | wdp0; }

inline void on_impl(uint8_t enable, at_1024K_t) noexcept
{ detail::_wdtcr = enable | wdp2 | wdp1; }

inline void on_impl(uint8_t enable, at_2048K_t) noexcept
